...
Modules=Virtex UltraScale+ HBM:0,Zynq UltraScale+ MPSoC:0,DocNav:0,Kintex UltraScale:0,Artix-7:1,Zynq-7000:0,System Generator for DSP:0,Virtex UltraScale+:0,Kintex UltraScale+:0,Model Composer:0
...
patchShebangs $out/opt/Vivado/2019.2/bin
...
patchelf --set-interpreter "$(cat $NIX_CC/nix-support/dynamic-linker)" $out/opt/Vivado/2019.2/lnx64/tools/eclipse/eclipse
...
wrapProgram $out/opt/Vivado/2019.2/lnx64/tools/eclipse/eclipse --prefix LD_LIBRARY_PATH : "$libPath"
